  ...
  return (
    <div className="h-full w-full bg-[#131313] text-[#e5e2e1] flex flex-col relative overflow-y-auto pb-[calc(2rem+env(safe-area-inset-bottom,0px))] selection:bg-primary-container selection:text-on-primary-container">
        ...
        <nav className="hidden lg:flex gap-4 z-10 overflow-x-auto max-w-[60%] hide-scrollbar py-1">
          {([
            ...
            <button
              ...
              className={`font-headline-md text-[11px] tracking-wider uppercase px-2.5 py-1 cursor-pointer transition-all border-b-2 hover:text-secondary font-bold flex items-center gap-1.5 whitespace-nowrap ${activeTab === tab.id
      ...
      <main className="flex-grow z-10 px-gutter md:px-[5%] lg:px-[10%] py-6 relative pb-24 md:pb-6">
        ...
        {isFirstVisit && (
          <div className="h-full w-full flex flex-col items-center justify-center gap-8 max-w-2xl mx-auto py-12">
            {/* Game Title & Tagline */}
            <div className="text-center space-y-4 animate-float">
              <div className="flex justify-center mb-6">
                <div className="w-24 h-24 rounded-full border-4 border-primary shadow-[0_0_30px_rgba(233,193,118,0.4)] flex items-center justify-center bg-gradient-to-br from-primary/20 to-secondary/20">
                  <span className="material-symbols-outlined text-6xl text-primary animate-pulse">eco</span>
                </div>
              </div>

              <h1 className="font-headline-md text-4xl md:text-5xl text-primary font-bold tracking-widest drop-shadow-[0_0_20px_rgba(233,193,118,0.5)] uppercase">
                The Serpent Kingdom
              </h1>

              <p className="text-xl md:text-2xl text-secondary font-bold tracking-wide italic drop-shadow-[0_0_10px_rgba(78,222,163,0.3)]">
                "Reclaim your throne. Devour the souls. Ascend."
              </p>
            </div>

            {/* Game Description */}
            <div className="glass-panel p-8 rounded-2xl border border-primary/30 space-y-4 max-w-xl backdrop-blur-xl">
              <p className="text-sm md:text-base text-on-surface leading-relaxed">
                Welcome, Ancient One. Your crown has been stolen. Your throne lies empty. But you are no mere serpent—you are a primordial force of chaos, awakened from the deepest abyss.
              </p>

              <p className="text-sm md:text-base text-on-surface leading-relaxed">
                Descend into cursed dimensions. Consume glowing souls to grow your might. Master eldritch abilities. Unleash devastating powers. Face legendary bosses. And reclaim what is yours.
              </p>

              <div className="pt-4 border-t border-outline-variant/30">
                <p className="text-xs md:text-sm text-on-surface-variant font-bold uppercase tracking-wider">
                  ⚔️ Action-Packed Roguelite Gameplay
                </p>
                <p className="text-xs md:text-sm text-on-surface-variant font-bold uppercase tracking-wider mt-2">
                  🏆 Deep Progression Systems & Customization
                </p>
                <p className="text-xs md:text-sm text-on-surface-variant font-bold uppercase tracking-wider mt-2">
                  👑 Epic Boss Battles & Multiple Biomes
                </p>
              </div>
            </div>
            ...
            {/* Hero CTA Button */}
            <button
              id="onboarding-hero-play-btn"
              onClick={() => {
                if (onMarkFirstVisitComplete) onMarkFirstVisitComplete();
                onStartGame();
              }}
              className="stone-button px-12 py-6 rounded-xl font-headline-md text-2xl text-primary flex items-center justify-center gap-3 cursor-pointer select-none font-bold tracking-widest shadow-[0_0_30px_rgba(233,193,118,0.5)] hover:shadow-[0_0_50px_rgba(78,222,163,0.8)] hover:text-secondary group active:scale-95 transition-all animate-pulse"
            >
            ...
            <button
              ...
              className="text-secondary hover:text-primary transition-colors font-bold uppercase tracking-wider text-sm border-b-2 border-secondary/30 hover:border-primary pb-1"
            >
              Learn More →
            </button>
          </div>
        ...
        {/* NORMAL DASHBOARD (for returning players) */}
        {!isFirstVisit && (
          <div>
                  ...
                  {BIOMES.map((biome) => {
                    ...
                    return (
                      <div
                        ...
                        className={`glass-panel p-5 rounded-xl border flex flex-col md:flex-row justify-between items-start md:items-center gap-4 transition-all ${isLocked
                      ...
                      >
                        ...
                        {isLocked ? (
                          ...
                          <button
                            type="button"
                            className={`font-label-sm uppercase text-xs tracking-wider px-4 py-2 rounded-md ${isSelected
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-gutter mb-8">
                  {ALL_SKINS.map((skin) => {
                    ...
                    return (
                      <article
                        key={skin.id}
                        className={`glass-panel rounded-lg overflow-hidden card-glow transition-all duration-300 group cursor-pointer relative ${isEquipped ? "border-secondary shadow-[0_0_15px_rgba(78,222,163,0.3)]" : "border-outline-variant/20"
                          }`}
                      >
                        {/* Rarity badge */}
                        ...
                        <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end">
                          {isMax ? (
                            ...
                            <button
                              ...
                              disabled={!canAfford}
                              className={`flex items-center gap-2 px-5 py-2.5 rounded font-label-numeric text-xs font-bold transition-all cursor-pointer ${canAfford
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {SKILL_NODES.map((node) => {
                    ...
                    return (
                      <article
                        key={node.id}
                        className={`glass-panel p-5 rounded-xl border transition-all duration-300 relative flex flex-col justify-between ${isLockedByDependency
                        ...
                        <div className="mt-4 pt-3 border-t border-outline-variant/20 flex gap-2">
                          {isMax ? (
                            ...
                            <button
                              ...
                              className={`w-full py-2 rounded text-xs font-bold tracking-wider uppercase transition-all cursor-pointer font-label-numeric ${isLockedByDependency
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter">
                  {ALL_RELICS.map((relic) => {
                    ...
                    return (
                      <article
                        key={relic.id}
                        className={`glass-panel p-5 rounded-xl border transition-all duration-300 flex flex-col justify-between ${isEquipped
                        ...
                        <div className="mt-5 pt-3 border-t border-outline-variant/10">
                          {isOwned ? (
                            <button
                              ...
                              className={`w-full py-2 rounded text-xs font-bold tracking-wider uppercase transition-all cursor-pointer font-label-numeric ${isEquipped
                            ...
                            <button
                              ...
                              className={`w-full py-2 rounded text-xs font-bold tracking-wider uppercase transition-all cursor-pointer font-label-numeric ${canAfford
                  ...
                  {ALL_FORMS.map((form) => {
                    ...
                    return (
                      <article
                        ...
                        className={`glass-panel rounded-xl overflow-hidden border transition-all duration-300 flex flex-col justify-between group cursor-pointer ${isActiveSelection
                  ...
                  {DAILY_REWARDS.map((reward) => {
                    ...
                    return (
                      <article
                        ...
                        className={`glass-panel p-4 rounded-xl border flex flex-col justify-between items-center text-center transition-all duration-200 relative ${isClaimed
              ...
              <div className="max-w-2xl mx-auto animate-float">
                ...
                <section className="glass-panel p-6 rounded-xl border border-purple-500/30 bg-[#191522] relative overflow-hidden">
                  ...
                  <button
                    ...
                    className={`w-full py-4 rounded-xl font-headline-md text-sm font-bold tracking-widest uppercase transition-all duration-150 flex items-center justify-center gap-2 cursor-pointer ${saveState.highScore >= 80000 || saveState.souls >= 200
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {DEFAULT_ACHIEVEMENTS.map((ach) => {
                      ...
                      return (
                        <div
                          key={ach.id}
                          className={`glass-panel p-4 rounded-xl border flex gap-3 ${isCompleted
              ...
              {([
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-5 py-3 text-xs font-bold tracking-wider uppercase border-b-2 transition-all cursor-pointer whitespace-nowrap ${isActive
                      ...
                      {ALL_TITLES.map((t) => {
                        ...
                        return (
                          <article
                            ...
                            className={`p-3.5 rounded-lg border text-left flex justify-between items-center transition-all ${isOwned
                      ...
                      {ALL_BADGES.map((b) => {
                        ...
                        return (
                          <article
                            ...
                            className={`p-3.5 rounded-lg border text-left flex gap-3 items-center transition-all ${isOwned
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {ALL_FRAMES.map((f) => {
                      ...
                      return (
                        <article
                          key={f.id}
                          className={`glass-panel p-4 rounded-xl border flex flex-col justify-between transition-all ${isEquipped
                        ...
                        >
                          <div className="flex items-start gap-4">
                            ...
                            <div className="text-left">
                              <h4 className="text-xs font-bold text-on-surface flex items-center gap-1.5">
                                {f.name}
                                <span className={`text-[8px] px-1.5 py-0.2 rounded font-mono font-bold ${f.rarity === "COMMON" ? "bg-on-surface-variant/10 text-on-surface-variant" :
                          ...
                          <div className="mt-4 pt-3 border-t border-outline-variant/10">
                            {isOwned ? (
                              <button
                                ...
                                disabled={isEquipped}
                                className={`w-full py-1.5 rounded text-[10px] font-bold tracking-widest uppercase transition-all font-mono cursor-pointer ${isEquipped
                              ...
                              <button
                                ...
                                className={`w-full py-1.5 rounded text-[10px] font-bold tracking-widest uppercase transition-all font-mono cursor-pointer flex justify-center items-center gap-1.5 ${canAfford
                      ...
                      <div className="mt-6 flex flex-col justify-center items-center">
                        {isHatching ? (
                          ...
                          <button
                            ...
                            className={`px-8 py-3 rounded-lg text-xs font-bold tracking-widest uppercase transition-all font-mono cursor-pointer shadow-lg flex items-center gap-2 ${saveState.dragonEggs && saveState.dragonEggs > 0
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {HATCHABLE_DRAGONS.map((d) => {
                          ...
                          return (
                            <article
                              key={d.name}
                              className={`p-4 rounded-xl border flex gap-4 text-left transition-all ${isOwned
                            ...
                            >
                              ...
                              <div>
                                <h4 className="text-xs font-bold text-on-surface flex items-center gap-1.5">
                                  {d.name}
                                  <span className={`text-[8px] px-1.5 py-0.2 rounded font-mono font-bold ${d.rarity === "RARE" ? "bg-blue-500/20 text-blue-400" :
